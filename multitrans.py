...
group2 = OptionGroup(parser, "Copy")
group2.add_option("-F",
        metavar="<FILE>",
	dest="file",
	type='string',
...
group2.add_option("-D",
	...
	dest="dest",
	type='string',
        help="Remote destenation directory path for copied files")
group2.add_option("-P",
	metavar="<YES/NO>",
	default='NO',
	dest="prev",
	choices=['YES', 'NO'],
        help="Preserves file permissions? (default: %default, 0644)")
group2.add_option("-M",
        metavar="<MODE>",
	dest="mode",
	type='string',
        help="Save file with given permissions (0000-4777)")

group3 = OptionGroup(parser, "Advanced")
group3.add_option("-T",
        metavar="<THREADS>",
	dest="threads",
	type='int',
...
group5 = OptionGroup(parser, "Platforms",
